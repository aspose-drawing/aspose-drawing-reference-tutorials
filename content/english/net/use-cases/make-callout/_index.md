...
namespace Aspose.Drawing.Examples.CSharp.UseCases
{
    internal class MakeCallOut
    {
        ...
        {
            // callout with size
            using (var image = Image.FromFile(Path.Combine("Your Document Directory", "UseCases", "gears.png")))
            {
                ...
                image.Save(Path.Combine("Your Document Directory", "UseCases", "gears_with_callout_out.png"));
            }
