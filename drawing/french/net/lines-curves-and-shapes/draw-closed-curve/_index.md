...
## Qu'est-ce que « enregistrer le bitmap au format PNG » dans Aspose.Drawing ?
...
2. **Environnement de développement .NET** – Visual Studio, VSCode, ou tout IDE supportant C#.
...
## Étape 1 : Créer l’image bitmap et les objets graphiques
...
## Étape 2 : Définir le stylet et tracer une courbe fermée
...
## Étape 3 : Enregistrer l’image de sortie (au format PNG)
